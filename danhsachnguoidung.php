            ...
            <div class="row content">
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        $value_phone = 'value="' . htmlspecialchars($result['sdt']) . '"';
                        ?>
                        ...
                        <div class="col-sm-6" style="width: 550px ;">
                            ...
                            ?>
                            <form action="" method="POST">
                                <input type="text" size="61%" placeholder="Nhập tin nhắn" name="input_mess" <?= htmlspecialchars($value_mess) ?>>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td><a href="?idmess=<?= $mess['idmess'] ?>&id=<?= $_GET['id'] ?>&noidung=<?= htmlspecialchars($mess['noidung']) ?>"><img src="./image/edit.png" width="70%"></a></td>
                                                <td><a href="delete.php?idmess=<?= $mess['idmess'] ?>&iddsnd=<?= $_GET['id'] ?>&token=<?=$token?>"><img src="./image/delete.png" width="70%"></a></td>
                                            <?php
                                            } else {
                                            ?>
