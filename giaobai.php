                        ...
                        ?>
                            <div class="container" style="width: 800px; ">
                                ...
                                ?> -->
                                    ...
                                    <?php
                                    $sql1 = 'SELECT bailam.*, user.username FROM bailam INNER JOIN user ON bailam.id_hocsinh=user.id';
                                    $result1 = GetData($sql1);
                                    while ($row = mysqli_fetch_assoc($result1)) {
                                    ?>
                                        <tbody>
                                            <td><?=$row['ten_filebailam']?></td>
                                            <td><?=$row['username']?></td>
                                            <td style="text-align: center"><?php echo "<a href='download.php?nama=/bailam/" . $row['id_baitap'] ."/".$row['ten_filebailam']. "'><img src='./image/download.png' ></a> "; ?></td>
                                        </tbody>
                                    <?php
